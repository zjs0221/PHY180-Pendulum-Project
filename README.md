To create the graphs, first download all .txt and .py files, then change the location of the files inside fit_graph.py to wherever the files are downloaded in your file directory. 
